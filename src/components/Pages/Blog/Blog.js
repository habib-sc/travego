...
const Blog = () => {
    return (
        <div className='container mx-auto  my-5'>
            ...
            <div class=" row row-cols-1 mx-md-5 px-md-5 g-4">
                <div class="col">
                    <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Difference between authorization and authentication</h5>
                        <p class="card-text">Bacically authentication verify a user. Authentication check the user is known or unknown. It works with passwords, pins, biometric info provided by users. On the other hand Authorization define users capability. That means how many resources user can access. It works with settings of a system that are implemented by organization. </p>
                    </div>
                    </div>
                </div>
                <div class="col">
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">They provide some services without authentication. Such as firebase database, realtime database, storage, hosting, functions and machine learning.</p>
                    </div>
                    </div>
                </div>
            </div>
